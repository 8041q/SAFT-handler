...
- Em seguida, vai abrir o explorador de arquivos e vais selecionar o ficheiro .JAR (java) e depois o ficheiro .XML
- Ira aparecer o comando que será executado, para que verifiques se há algum erro (senha incorreta, mês, etc)
- De seguida vai aparecer uma opção para executar o script, escreva "y" ou "Y" para confirmar e dê Enter
...
- The script will then show the command it will run so that you check for any error (bad password, month, etc)
